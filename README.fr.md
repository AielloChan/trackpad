...
- Pincement/ecartement a deux doigts avec evenement de zoom independant de la plateforme; l'hote macOS actuel utilise un repli par defilement modifie, positionne sur le curseur.
